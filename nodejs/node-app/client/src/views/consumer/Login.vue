      ...
      <div class="lowin-box lowin-login">
        <div class="lowin-box-inner">
            ...
            <div class="lowin-group">
              ...
              <input type="email"  v-model="user.email" class="lowin-input">
            </div>
            ...
            <button class="lowin-btn login-btn"  @click="submitForm">登陆</button>

            <div class="text-foot">
              <a class="register-link"  @click="Register">注册</a>
            </div>
